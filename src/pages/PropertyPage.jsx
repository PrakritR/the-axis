          ...
          <div key={idx} className="grid grid-cols-1 items-center gap-2 py-4 sm:grid-cols-12 sm:gap-3">
            ...
            <div className="sm:col-span-2 flex justify-end">
              <button
                ...
                className="rounded-full border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:border-axis hover:text-axis"
              >
                Details
              </button>
            </div>
                ...
                {p.leaseTerms.map((term) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="text-xs font-bold uppercase tracking-[0.18em] text-axis">{term.type}</div>
                      {term.badge ? (
                    ...
                    <div className="mt-4 space-y-2.5">
                      ...
                      <div className="flex items-start justify-between gap-2 text-sm">
                        ...
                        <span className="font-bold text-slate-900 text-right">{term.moveOutLabel || term.moveOut}</span>
                      </div>
